...
static const Rule rules[] = {
    ...
    /* reference: https://dwm.suckless.org/customisation/tagmask/ */

	/* class      instance    title       tags mask     isfloating   monitor */
    { "firefox",     NULL,    NULL,       1,            0,           -1 },
    { "emacs",       NULL,    NULL,       1 << 1,       0,           -1 },
    { "betterbird",  NULL,    NULL,       1 << 7,       0,           -1 },
...
/* commands */
/* TODO remove this dmenumon so it spawns in whichever monitor is active */
static char dmenumon[2] = "0"; /* component of dmenucmd, manipulated in spawn() */
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
static const char *dmenuqalccmd[] = { "dmenu", "-C", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
static const char *termcmd[]  = { "st", NULL };
static const char *scrotcmd[]  = { "flameshot", "gui", NULL };
static const char *lockcmd[]  = { "slock", NULL };
static const char *incbrightcmd[]  = { "light", "-T", "1.618", NULL };
static const char *decbrightcmd[]  = { "light", "-T", "0.618", NULL };
static const char *incvolumecmd[]  = { "pactl", "set-sink-volume", "@DEFAULT_SINK@", "+2dB", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_c,      spawn,          {.v = dmenuqalccmd } },
